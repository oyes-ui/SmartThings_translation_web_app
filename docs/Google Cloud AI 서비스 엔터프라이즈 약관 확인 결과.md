...
| 산정 항목 | 기준 | 예상 비용 |
|----------|------|----------:|
| AI 번역/검수 | 엑셀 1개당 2회 실행 기준, 월 6개 x 8회 | 약 89,568원 |
| 이미지 생성 | Nano Banana Pro 기준, 100장 | 약 20,100~36,000원 |
| 영상 생성 | Omni 대체 Veo 3.1 기준, 10초 1개 | 약 6,000~9,000원 |
| **총합** | 기본형~4K 최대형 | **약 115,668~134,568원** |

#### AI 번역 및 검수

- 과금 방식: **토큰 사용량 기반 후불 과금**
- 대표 기준: **엑셀 1개당 2회 실행 기준 약 1,866원**
- 전체 산식: **1,866원 x 월 6개 x 8회 = 약 89,568원**
- 보조 근거:
...
> [!TIP]
> 아래 문구는 슬라이드 박스에 바로 옮길 수 있도록 짧은 줄 단위로 정리했습니다.

#### Enterprise 요금제 비용

- Google AI Studio API key 기반 사용량 과금
- 번역/검수: 엑셀 1개당 2회 실행 기준 약 1,866원
- 전체 번역/검수 예상: 약 89,568원
